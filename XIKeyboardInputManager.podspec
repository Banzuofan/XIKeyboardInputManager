...
s.description      = '${s.summary} when use it, you only need to focus on making the specified input view as the designed UI.'
  ...
  s.author           = { 'banzuofan@hotmail.com' => 'yangxiaolong3@jd.com' }
  s.source           = { :git => 'https://github.com/banzuofan@hotmail.com/XIKeyboardInputManager.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'XIKeyboardInputManager/Classes/**/*'
